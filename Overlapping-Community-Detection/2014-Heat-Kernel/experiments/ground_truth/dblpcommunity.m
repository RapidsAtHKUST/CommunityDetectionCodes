% Compare the recall of hk and ppr on ground-truth communities in dblp
...
save([output_directory 'dblpcommunity' '.mat'],'fmeas','conds','recalls','precisions', 'bestrecsize', 'condofbestfmeas','bestrecsize','-v7.3');