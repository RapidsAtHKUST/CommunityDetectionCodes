% Compare the recall of hk and ppr on ground-truth communities in youtube
...
save([output_directory 'youtubecommunity' '.mat'],'fmeas','conds','recalls','precisions', 'bestrecsize', 'condofbestfmeas','bestrecsize','-v7.3');