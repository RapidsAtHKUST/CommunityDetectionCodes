% nohup /p/matlab-7.14/bin/matlab -nodisplay -nodesktop -nojvm -nosplash -r pprheavytwitter > pprhvtwit.txt &
...
tic; [dummy,conds(trial_num),cuts(trial_num),vols(trial_num)] = pprgrow(A,indices(trial_num),'neighborhood',true);
times(trial_num) = toc;
...
save([output_directory outputname '.mat'], 'perms','dataname', 'gsize', 'setsizes', 'vols', 'cuts', 'indices', 'times', 'conds', 'filename','-v7.3');
exit;
