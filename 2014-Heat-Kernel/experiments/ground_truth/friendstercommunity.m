% Compare the recall of hk and ppr on ground-truth communities in friendster
% nohup /p/matlab-7.14/bin/matlab -nodisplay -nodesktop -nojvm -nosplash -r friendstercommunity > friendcomm.txt &

load('../../data/' 'friendcommC']);
load('../../data/' 'friendcommCtop']);
fprintf('done loading comm info\n');
load('../../data/' dataset]);
fprintf('done loading friendster\n');
...
save([output_directory 'friendstercommunity' '.mat'],'fmeas','conds','recalls','precisions', 'bestrecsize', 'condofbestfmeas','bestrecsize','-v7.3');