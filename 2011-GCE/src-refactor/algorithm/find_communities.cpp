...
int main(int argc, char **argv) {
    ...
    if (argc != 6 && (argc != 2 || ((strcmp(argv[1], "--?")) == 0) || ((strcmp(argv[1], "--help")) == 0) ||
                      ((strcmp(argv[1], "-h")) == 0))) {
        cout
        ...
        cout << endl << "Usage: " << argv[0]
             << " graphfilename minimumCliqueSizeK overlapToDiscardEta fitnessExponentAlpha CCHthresholdPhi" << endl;
    ...
    cerr << "Running with parameters: k: " << minimumCliqueSize << " eta: " << minimumOverlapToMerge << " alpha: "
         << alphaValueForFitness << " Phi: " << spokenForThresholdOfUniqueness << endl;
