...
public class COPRA {
    ...
    static String welcome2 = "* copra.COPRA v1.25  (c) Steve Gregory 2011 *";
    ...
    public static void main(String[] var0) {
        ...
        try {
            ...
            System.err.println("copra.COPRA error: " + var68.toString());
    ...
    private static void printUsageAndExit() {
        System.err.println("Usage: java copra.COPRA <file> <options>");
