...
import conga.algorithm.Between;
import conga.algorithm.PB;
import conga.util.Pair;
import conga.util.StrPair;
import conga.util.Tree;
import conga.util.benchmark.GResult;
import conga.util.community.BP;
import conga.util.community.ClusterInfo;
import conga.util.graph.Split;
import conga.util.community.Stats;
import conga.util.graph.Edge;
import conga.util.graph.Vertex;
import conga.util.metric.ModOverlap;
    ...
    private static Stats clusterGraph1(int var0, String var1, int var2, HashSet<String> var3, boolean var4, boolean var5, int var6, int var7, int var8, int var9, int var10, int var11, String var12, String var13, String var14, String var15, String var16, String var17, String var18, int var19, double var20, int var22, int var23, double var24, boolean var26, boolean var27, String var28, boolean var29) throws Exception {
        ...
        if (var27) {
            ...
            if (!var3.contains("off") && !var28.equals("min") && !var28.equals("max") && !var28.equals("mean") && Float.parseFloat(var28) <= 0.0F) {
                System.err.println("conga.util.graph.Split weight must be positive, or min or mean or max");
                System.exit(1);
            }
