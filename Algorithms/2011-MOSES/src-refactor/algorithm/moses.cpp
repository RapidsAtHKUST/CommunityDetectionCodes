...
int main(int argc, char **argv) {
    ...
    if (argc - optind != 2) {
        ...
        cout
                << " [--saveMOSESscores FILENAME]: store the delta-objective for each community here (log-ratio of the MOSES posterior density). "
                << endl;
        cout << endl;
        ...
        cout << endl;
        cout
                << "- Aaron McDaid, Neil Hurley. Detecting highly overlapping communities with Model-based Overlapping Seed Expansion. ASONAM 2010. http://irserver.ucd.ie/dspace/handle/10197/2404 "
                << endl;
        cout << endl;
