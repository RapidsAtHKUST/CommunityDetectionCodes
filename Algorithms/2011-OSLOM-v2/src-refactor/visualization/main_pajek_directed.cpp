...
int main(int argc, char *argv[]) {
    ...
    if (argc < 2) {
        ...
        cerr
                << "The scale_factor is optional. You might want to specify it because the scale sometimes is not perfect. For instance, if you want a bigger visualization, try: "
                << endl;
        ...
        cerr
                << "the pajek_files are called pajek_files_1.net, pajek_files_2.net and so on, one for each hierarchical level. Enjoy!"
                << endl << endl;
        return -1;
    }
    srand_file();
