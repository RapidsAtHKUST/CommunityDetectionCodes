...
int xybinning(deque<type> &c, deque<type> &d, int number_of_bins,
              deque<double> &xs, deque<double> &ys, deque<double> &var, deque<int> &nums) {
...
template<typename type>
int xybinning(deque<type> &c, deque<type> &d, int number_of_bins, deque<double> &xs, deque<double> &ys,
              deque<double> &var) {
    deque<int> nums;
...
template<typename type>
int xybinning_quantiles(deque<type> &c, deque<type> &d, int number_of_bins, deque<double> &xs, deque<double> &ys,
                        deque<double> &var, deque<int> &nums, deque<deque<double> > &Mq, double qa, double qb) {
    // so, this function takes two datasets (c and d) and gathers the data in bin, takes xs and ys as the average in each bin, var is the variance of the y average
    // the difference with the same stuff called not_norm_histogram is that the other one averages x with y weights.
    xs.clear();
    ys.clear();
...
int log_histogram(deque<double> &c, deque<double> &c2, ostream &out,
                  int number_of_bins);
...
template<typename type>
int
not_norm_histogram_correlated(deque<type> &c, deque<type> &d, ostream &out, int number_of_bins, double b1, double b2) {
